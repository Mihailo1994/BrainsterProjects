    ...
    <div class="container-fluid">
        <div class="row" id="generate-section">
            <div class="col">
                ...
                <form method="POST" action="{{route('termin.store',$accommodation->id)}}">
                    @csrf
                    <div class="mb-3 p-3 border rounded">
                        <div id="termin-section">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="date" readonly="true" class="form-control" name="date_from[]" value="{{$termin['date_from']}}">
                                </div>
                                <div class="col">
                                    <label>Термин до</label>
                                    <input type="date" readonly="true" class="form-control" name="date_until[]" value="{{$termin['date_until']}}">
                                </div>
                                <div class="col">
